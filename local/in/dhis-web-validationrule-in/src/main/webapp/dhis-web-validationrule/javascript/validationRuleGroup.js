...
function showValidationRuleGroupDetails( id )
{
    ...
    var requestString = "getValidationRuleGroup.action";
    var params = "id=" + id;
...
function removeValidationRuleGroup( validationRuleGroupId, validationRuleGroupName )
{
    ...
    if ( result )
    {
        ...
        document.delForm.id.value = validationRuleGroupId;
...
function editValidationRuleGroup( validationRuleGroupId )
{
    document.editForm.id.value = validationRuleGroupId;
...
function validateAddValidationRuleGroup()
{
    ...
    var requestString = "validateValidationRuleGroup.action";
    var params = "name=" + getFieldValue( "name" ) + "&description=" + getFieldValue( "description" );
    request.sendAsPost( params );
    request.send( requestString );
    return false;
}
...
function validateUpdateValidationRuleGroup()
{
    ...
    //request.send( 'validateValidationRuleGroup.action?id=' + getFieldValue( 'id' ) + '&name=' + getFieldValue( 'name' ) + '&description=' + getFieldValue( 'description' ) );

    var requestString = "validateValidationRuleGroup.action";
    var params = "id=" + getFieldValue( "id" ) + "&name=" + getFieldValue( "name" ) + "&description=" + getFieldValue( "description" ) ;
    request.sendAsPost( params );
    request.send( requestString );
    return false;
}
