...
function showValidationRuleDetails( validationId )
{
    ...
    var requestString = "getValidationRule.action";
    var params = "id=" + validationId;
...
function removeValidationRule( ruleId, ruleName )
{
    ...
    if ( result )
    {
       ...
       document.delForm.id.value = ruleId;
       document.delForm.submit();
    }
}

function editValidationRuleGroup( ruleId )
{
    document.editForm.id.value = ruleId;
