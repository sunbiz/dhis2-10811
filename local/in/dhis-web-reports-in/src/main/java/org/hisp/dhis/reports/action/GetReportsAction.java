...
public class GetReportsAction implements Action
{
        ...
        throws Exception
    {
        ...
        if(ouId != null)
        {
            try
            {
                ...
                reportList = new ArrayList<Report_in>( reportService.getReportsByPeriodSourceAndReportType( selPeriodType, orgUnit, reportType ) ); 
