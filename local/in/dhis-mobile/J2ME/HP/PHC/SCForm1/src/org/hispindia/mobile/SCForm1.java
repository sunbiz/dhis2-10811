...
//<editor-fold defaultstate="collapsed" desc=" Generated Fields ">//GEN-BEGIN:|fields|0|
    ...
    private Command OutpatientCmd;
    private Command monthExitCmd;
    private Command InstitutionalDeliveriesbackcmd;
    private Command InstitutionalDeliveriesokcmd;
    ...
    public void commandAction(Command command, Displayable displayable) {//GEN-END:|7-commandAction|0|7-preCommandAction
        ...
        if (displayable == BlindnessControlProgramme) {//GEN-BEGIN:|7-commandAction|1|781-preAction
            ...
            if (command == Childhooddiseases05yrsbackcmd) {//GEN-END:|7-commandAction|5|777-preAction
                ...
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|9|1011-preAction
        } else if (displayable == HIVtestsconducted) {
            if (command == HIVtestsconductedBackCmd) {//GEN-END:|7-commandAction|9|1011-preAction
                // write pre-action user code here
                switchDisplayable(null, getLaboratoryTesting());//GEN-LINE:|7-commandAction|10|1011-postAction
                // write post-action user code here
            } else if (command == HIVtestsconductedCmd) {//GEN-LINE:|7-commandAction|11|1013-preAction
                // write pre-action user code here
                switchDisplayable(null, getWidaltestsconducted());//GEN-LINE:|7-commandAction|12|1013-postAction
                // write post-action user code here
            ...
            if (command == InPatientHeadCountatmidnightbackcmd) {//GEN-END:|7-commandAction|17|832-preAction
                ...
                // write pre-action user code here
                switchDisplayable(null, getOutpatient());//GEN-LINE:|7-commandAction|20|834-postAction
                // write post-action user code here
            ...
            if (command == OperationTheatrebackcmd) {//GEN-END:|7-commandAction|29|836-preAction
                // write pre-action user code here
                switchDisplayable(null, getOutpatient());//GEN-LINE:|7-commandAction|30|836-postAction
                // write post-action user code here
            ...
            if (command == Othersetcbackcmd) {//GEN-END:|7-commandAction|33|840-preAction
                ...
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|37|1004-preAction
        } else if (displayable == Outpatient) {
            if (command == OutpatientBackCmd) {//GEN-END:|7-commandAction|37|1004-preAction
                // write pre-action user code here
                switchDisplayable(null, getInPatientHeadCountatmidnight());//GEN-LINE:|7-commandAction|38|1004-postAction
                // write post-action user code here
            } else if (command == OutpatientCmd) {//GEN-LINE:|7-commandAction|39|1006-preAction
                // write pre-action user code here
                switchDisplayable(null, getOperationTheatre());//GEN-LINE:|7-commandAction|40|1006-postAction
                // write post-action user code here
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: Childhooddiseases05yrs ">//GEN-BEGIN:|774-getter|0|774-preInit
    ...
    public Form getChildhooddiseases05yrs() {
        if (Childhooddiseases05yrs == null) {//GEN-END:|774-getter|0|774-preInit
            // write pre-init user code here
            Childhooddiseases05yrs = new Form("Childhood Diseases (0-5yrs)", new Item[]{getTextField20(), getTextField21(), getTextField22(), getTextField23(), getTextField24(), getTextField(), getTextField1(), getTextField2(), getTextField25()});//GEN-BEGIN:|774-getter|1|774-postInit
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: BlindnessControlProgramme ">//GEN-BEGIN:|775-getter|0|775-preInit
    ...
    public Form getBlindnessControlProgramme() {
        if (BlindnessControlProgramme == null) {//GEN-END:|775-getter|0|775-preInit
            // write pre-init user code here
            BlindnessControlProgramme = new Form("Blindness Control Programme", new Item[]{getTextField26(), getTextField27(), getTextField28(), getTextField29()});//GEN-BEGIN:|775-getter|1|775-postInit
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: stringItem2 ">//GEN-BEGIN:|952-getter|0|952-preInit
    ...
    public StringItem getStringItem2() {
        if (stringItem2 == null) {//GEN-END:|952-getter|0|952-preInit
            // write pre-init user code here
            stringItem2 = new StringItem(LocalizationSupport.getMessage("HIV_tests_conducted"), null);//GEN-LINE:|952-getter|1|952-postInit
            // write post-init user code here
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: InstitutionalDeliveriesbackcmd ">//GEN-BEGIN:|992-getter|0|992-preInit
    /**
     * Returns an initialized instance of InstitutionalDeliveriesbackcmd
     * component.
     *
     ...
     */
    public Command getInstitutionalDeliveriesbackcmd() {
        if (InstitutionalDeliveriesbackcmd == null) {//GEN-END:|992-getter|0|992-preInit
            // write pre-init user code here
            InstitutionalDeliveriesbackcmd = new Command("Back", Command.BACK, 0);//GEN-LINE:|992-getter|1|992-postInit
            // write post-init user code here
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: InstitutionalDeliveriesokcmd ">//GEN-BEGIN:|994-getter|0|994-preInit
    /**
     * Returns an initialized instance of InstitutionalDeliveriesokcmd
     * component.
     *
     * @return the initialized component instance
     */
    public Command getInstitutionalDeliveriesokcmd() {
        if (InstitutionalDeliveriesokcmd == null) {//GEN-END:|994-getter|0|994-preInit
            // write pre-init user code here
            InstitutionalDeliveriesokcmd = new Command("Next", Command.OK, 0);//GEN-LINE:|994-getter|1|994-postInit
            // write post-init user code here
        }//GEN-BEGIN:|994-getter|2|
        return InstitutionalDeliveriesokcmd;
    }
//</editor-fold>//GEN-END:|994-getter|2|

//<editor-fold defaultstate="collapsed" desc=" Generated Getter: textField ">//GEN-BEGIN:|1016-getter|0|1016-preInit
    /**
    ...
    public TextField getTextField() {
        if (textField == null) {//GEN-END:|1016-getter|0|1016-preInit
            // write pre-init user code here
            String str = getRecordValue(35);
            textField = new TextField(LocalizationSupport.getMessage("CD-Measles"), str, 4, TextField.NUMERIC);//GEN-LINE:|1016-getter|1|1016-postInit
            // write post-init user code here
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: textField1 ">//GEN-BEGIN:|1017-getter|0|1017-preInit
    /**
    ...
    public TextField getTextField1() {
        if (textField1 == null) {//GEN-END:|1017-getter|0|1017-preInit
            // write pre-init user code here
            String str = getRecordValue(43);
            textField1 = new TextField(LocalizationSupport.getMessage("CD-Diarr&Dehyd"), str, 4, TextField.NUMERIC);//GEN-LINE:|1017-getter|1|1017-postInit
            // write post-init user code here
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: textField2 ">//GEN-BEGIN:|1018-getter|0|1018-preInit
    /**
    ...
    public TextField getTextField2() {
        if (textField2 == null) {//GEN-END:|1018-getter|0|1018-preInit
            // write pre-init user code here
            String str = getRecordValue(44);
            textField2 = new TextField(LocalizationSupport.getMessage("CD-Malaria"), str, 4, TextField.NUMERIC);//GEN-LINE:|1018-getter|1|1018-postInit
            // write post-init user code here
        }//GEN-BEGIN:|1018-getter|2|
        return textField2;
    }
//</editor-fold>//GEN-END:|1018-getter|2|

//<editor-fold defaultstate="collapsed" desc=" Generated Getter: Outpatient ">//GEN-BEGIN:|1002-getter|0|1002-preInit
    /**
     * Returns an initialized instance of Outpatient component.
     *
     * @return the initialized component instance
     */
    public Form getOutpatient() {
        if (Outpatient == null) {//GEN-END:|1002-getter|0|1002-preInit
            // write pre-init user code here
            Outpatient = new Form("Patient Services ", new Item[]{getStringItem(), getTextField3()});//GEN-BEGIN:|1002-getter|1|1002-postInit
            Outpatient.addCommand(getOutpatientBackCmd());
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: stringItem ">//GEN-BEGIN:|1019-getter|0|1019-preInit
    /**
    ...
    public StringItem getStringItem() {
        if (stringItem == null) {//GEN-END:|1019-getter|0|1019-preInit
            // write pre-init user code here
            stringItem = new StringItem(LocalizationSupport.getMessage("Outpatient"), null);//GEN-LINE:|1019-getter|1|1019-postInit
            // write post-init user code here
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: textField3 ">//GEN-BEGIN:|1020-getter|0|1020-preInit
    /**
    ...
    public TextField getTextField3() {
        if (textField3 == null) {//GEN-END:|1020-getter|0|1020-preInit
            // write pre-init user code here
            String str = getRecordValue(45);
            textField3 = new TextField(LocalizationSupport.getMessage("OPD-ALL"), str, 4, TextField.NUMERIC);//GEN-LINE:|1020-getter|1|1020-postInit
            // write post-init user code here
        }//GEN-BEGIN:|1020-getter|2|
        return textField3;
    }
//</editor-fold>//GEN-END:|1020-getter|2|

//<editor-fold defaultstate="collapsed" desc=" Generated Getter: HIVtestsconducted ">//GEN-BEGIN:|1009-getter|0|1009-preInit
    /**
    ...
    public Form getHIVtestsconducted() {
        if (HIVtestsconducted == null) {//GEN-END:|1009-getter|0|1009-preInit
            // write pre-init user code here
            HIVtestsconducted = new Form("Laboratory Testing ", new Item[]{getStringItem1(), getTextField4(), getTextField5(), getTextField6(), getTextField7(), getTextField8(), getTextField9()});//GEN-BEGIN:|1009-getter|1|1009-postInit
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: stringItem1 ">//GEN-BEGIN:|1021-getter|0|1021-preInit
    /**
    ...
    public StringItem getStringItem1() {
        if (stringItem1 == null) {//GEN-END:|1021-getter|0|1021-preInit
            // write pre-init user code here
            stringItem1 = new StringItem(LocalizationSupport.getMessage("HIV_tests_conducted"), null);//GEN-LINE:|1021-getter|1|1021-postInit
            // write post-init user code here
        }//GEN-BEGIN:|1021-getter|2|
        return stringItem1;
    }
//</editor-fold>//GEN-END:|1021-getter|2|

//<editor-fold defaultstate="collapsed" desc=" Generated Getter: textField4 ">//GEN-BEGIN:|1022-getter|0|1022-preInit
    /**
    ...
    public TextField getTextField4() {
        if (textField4 == null) {//GEN-END:|1022-getter|0|1022-preInit
            // write pre-init user code here
            String str = getRecordValue(46);
            textField4 = new TextField(LocalizationSupport.getMessage("M(numbertested)"), str, 4, TextField.NUMERIC);//GEN-LINE:|1022-getter|1|1022-postInit
            // write post-init user code here
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: textField5 ">//GEN-BEGIN:|1023-getter|0|1023-preInit
    /**
    ...
    public TextField getTextField5() {
        if (textField5 == null) {//GEN-END:|1023-getter|0|1023-preInit
            // write pre-init user code here
            String str = getRecordValue(47);
            textField5 = new TextField(LocalizationSupport.getMessage("FNonANCtested"), str, 4, TextField.NUMERIC);//GEN-LINE:|1023-getter|1|1023-postInit
            // write post-init user code here
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: textField6 ">//GEN-BEGIN:|1024-getter|0|1024-preInit
    /**
    ...
    public TextField getTextField6() {
        if (textField6 == null) {//GEN-END:|1024-getter|0|1024-preInit
            // write pre-init user code here
            String str = getRecordValue(48);
            textField6 = new TextField(LocalizationSupport.getMessage("FwithANCtested"), str, 4, TextField.NUMERIC);//GEN-LINE:|1024-getter|1|1024-postInit
            // write post-init user code here
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: textField7 ">//GEN-BEGIN:|1025-getter|0|1025-preInit
    /**
    ...
    public TextField getTextField7() {
        if (textField7 == null) {//GEN-END:|1025-getter|0|1025-preInit
            // write pre-init user code here
            String str = getRecordValue(16);
            textField7 = new TextField(LocalizationSupport.getMessage("Mnumberpositive"), str, 4, TextField.NUMERIC);//GEN-LINE:|1025-getter|1|1025-postInit
            // write post-init user code here
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: textField8 ">//GEN-BEGIN:|1026-getter|0|1026-preInit
    /**
    ...
    public TextField getTextField8() {
        if (textField8 == null) {//GEN-END:|1026-getter|0|1026-preInit
            // write pre-init user code here
            String str = getRecordValue(17);
            textField8 = new TextField(LocalizationSupport.getMessage("FnonANCpositive"), str, 4, TextField.NUMERIC);//GEN-LINE:|1026-getter|1|1026-postInit
            // write post-init user code here
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: textField9 ">//GEN-BEGIN:|1027-getter|0|1027-preInit
    /**
    ...
    public TextField getTextField9() {
        if (textField9 == null) {//GEN-END:|1027-getter|0|1027-preInit
            // write pre-init user code here
            String str = getRecordValue(18);
            textField9 = new TextField(LocalizationSupport.getMessage("FwithANCpositive"), str, 4, TextField.NUMERIC);//GEN-LINE:|1027-getter|1|1027-postInit
            // write post-init user code here
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: OutpatientBackCmd ">//GEN-BEGIN:|1003-getter|0|1003-preInit
    /**
    ...
    public Command getOutpatientBackCmd() {
        if (OutpatientBackCmd == null) {//GEN-END:|1003-getter|0|1003-preInit
            // write pre-init user code here
            OutpatientBackCmd = new Command("Back", Command.BACK, 0);//GEN-LINE:|1003-getter|1|1003-postInit
            // write post-init user code here
        }//GEN-BEGIN:|1003-getter|2|
        return OutpatientBackCmd;
    }
//</editor-fold>//GEN-END:|1003-getter|2|

//<editor-fold defaultstate="collapsed" desc=" Generated Getter: OutpatientCmd ">//GEN-BEGIN:|1005-getter|0|1005-preInit
    /**
     * Returns an initialized instance of OutpatientCmd component.
     *
     * @return the initialized component instance
     */
    public Command getOutpatientCmd() {
        if (OutpatientCmd == null) {//GEN-END:|1005-getter|0|1005-preInit
            // write pre-init user code here
            OutpatientCmd = new Command("Ok", Command.OK, 0);//GEN-LINE:|1005-getter|1|1005-postInit
            // write post-init user code here
        }//GEN-BEGIN:|1005-getter|2|
        return OutpatientCmd;
    }
//</editor-fold>//GEN-END:|1005-getter|2|

//<editor-fold defaultstate="collapsed" desc=" Generated Getter: HIVtestsconductedBackCmd ">//GEN-BEGIN:|1010-getter|0|1010-preInit
    /**
    ...
    public Command getHIVtestsconductedBackCmd() {
        if (HIVtestsconductedBackCmd == null) {//GEN-END:|1010-getter|0|1010-preInit
            // write pre-init user code here
            HIVtestsconductedBackCmd = new Command("Back", Command.BACK, 0);//GEN-LINE:|1010-getter|1|1010-postInit
            // write post-init user code here
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: HIVtestsconductedCmd ">//GEN-BEGIN:|1012-getter|0|1012-preInit
    /**
    ...
    public Command getHIVtestsconductedCmd() {
        if (HIVtestsconductedCmd == null) {//GEN-END:|1012-getter|0|1012-preInit
            // write pre-init user code here
            HIVtestsconductedCmd = new Command("Ok", Command.OK, 0);//GEN-LINE:|1012-getter|1|1012-postInit
            // write post-init user code here
...
//</editor-fold>//GEN-END:|1012-getter|2|
  //<editor-fold defaultstate="collapsed" desc=" getEmptyFields() ">
    ...
    private String collectFormData(String monthStr, String freqStr) {
        ...
        // lengh of "HP NRHM "+ + subCenter + formID + "*" + monthData + "$" + "86" + "?" is 22 characters
        if(myData.length() > 138 - 40)
        {
            ...
            while(seperateIndex < myDataTemp.length){
                ...
                int csvIndex = seperateIndex + 86; // PHC form 1 ended at index 87 in CSV file
            ...
            myReturnData = "HP NRHM "+ subCenter + formID + "*" + monthData + "$" + "86" + "?" + myData;
        }
