...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: ANC_Services ">//GEN-BEGIN:|518-getter|0|518-preInit
    ...
    public Form getANC_Services() {
        if (ANC_Services == null) {//GEN-END:|518-getter|0|518-preInit
            // write pre-init user code here
            ANC_Services = new Form("ANC Services", new Item[]{getTextField(), getTextField1(), getTextField2(), getTextField3(), getTextField4(), getTextField5(), getTextField6(), getTextField7(), getTextField13(), getTextField8(), getTextField86()});//GEN-BEGIN:|518-getter|1|518-postInit
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: Complicatedpregnancies ">//GEN-BEGIN:|578-getter|0|578-preInit
    ...
    public Form getComplicatedpregnancies() {
        if (Complicatedpregnancies == null) {//GEN-END:|578-getter|0|578-preInit
            // write pre-init user code here
            Complicatedpregnancies = new Form("Complicated Pregnancies", new Item[]{getTextField24(), getStringItem(), getTextField25(), getTextField76(), getTextField77(), getTextField87()});//GEN-BEGIN:|578-getter|1|578-postInit
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: textField86 ">//GEN-BEGIN:|779-getter|0|779-preInit
    /**
    ...
    public TextField getTextField86() {
        if (textField86 == null) {//GEN-END:|779-getter|0|779-preInit
            // write pre-init user code here
            String str = getRecordValue(97);
            textField86 = new TextField(LocalizationSupport.getMessage("HB<7treated"), str, 4, TextField.NUMERIC);//GEN-LINE:|779-getter|1|779-postInit
            // write post-init user code here
        }//GEN-BEGIN:|779-getter|2|
        return textField86;
    }
//</editor-fold>//GEN-END:|779-getter|2|

//<editor-fold defaultstate="collapsed" desc=" Generated Getter: textField87 ">//GEN-BEGIN:|780-getter|0|780-preInit
    /**
    ...
    public TextField getTextField87() {
        if (textField87 == null) {//GEN-END:|780-getter|0|780-preInit
            // write pre-init user code here
            String str = getRecordValue(98);
            textField87 = new TextField(LocalizationSupport.getMessage("BloodTransfusion"), str, 4, TextField.NUMERIC);//GEN-LINE:|780-getter|1|780-postInit
            // write post-init user code here
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    lastMsgStore.setRecord(97, textField86.getString().getBytes(), 0, textField86.getString().length());
                    lastMsgStore.setRecord(98, textField87.getString().getBytes(), 0, textField87.getString().length());
