...
*/
	...
	setInnerHTML( 'idField', getElementValue( lineListGroupElement, 'id' ) );
	setInnerHTML( 'nameField', getElementValue( lineListGroupElement, 'name' ) );
	setInnerHTML( 'shortNameField', getElementValue( lineListGroupElement, 'shortName' ) );
	setInnerHTML( 'periodTypeField', getElementValue( lineListGroupElement, 'periodType' ) );
	...
	setInnerHTML( 'memberCountField', getElementValue( lineListGroupElement, 'memberCount' ) );
...
function validateUpdateLineListGroup()
{
    ...
    request.send( 'validateLineListGroup.action?id=' + getFieldValue( 'id' ) +
        ...
        '&selectedList=' + selectedList +  '&selectedListNumber=' + selectedListNumber );
