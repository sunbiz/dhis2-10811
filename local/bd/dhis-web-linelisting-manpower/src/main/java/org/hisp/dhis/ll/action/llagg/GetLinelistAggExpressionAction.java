...
public class GetLinelistAggExpressionAction
    implements Action
{
     ...
     * 
     * public void setCategoryService( DataElementCategoryOptionComboService
    ...
    public String execute()
    {
        ...
        DataElementCategoryOptionCombo deCoc = categoryService.getDataElementCategoryOptionCombo( Integer
            .parseInt( aggdeId.split( ":" )[1] ) );

        LinelistAggregationMapping linelistAggMapping = linelistAggMapService
            .getLinelistAggregationMappingByOptionCombo( dataElement, deCoc );
