...
*/
	...
	byId('idField').innerHTML = lineListElementElement.getElementsByTagName( 'id' )[0].firstChild.nodeValue;

	byId('nameField').innerHTML = lineListElementElement.getElementsByTagName( 'name' )[0].firstChild.nodeValue;

	byId('shortNameField').innerHTML = lineListElementElement.getElementsByTagName( 'shortName' )[0].firstChild.nodeValue;

	byId('dataTypeField').innerHTML = lineListElementElement.getElementsByTagName( 'dataType' )[0].firstChild.nodeValue;

	byId('presentationTypeField').innerHTML = lineListElementElement.getElementsByTagName( 'presentationType' )[0].firstChild.nodeValue;

	byId('memberCountField').innerHTML = lineListElementElement.getElementsByTagName( 'memberCount' )[0].firstChild.nodeValue;
