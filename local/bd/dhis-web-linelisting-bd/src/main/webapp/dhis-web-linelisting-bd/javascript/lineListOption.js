...
function LineListOptionReceived( LineListOptionElement )
{
    ...
    */
	...
	byId('idField').innerHTML = LineListOptionElement.getElementsByTagName( 'id' )[0].firstChild.nodeValue;

	byId('nameField').innerHTML = LineListOptionElement.getElementsByTagName( 'name' )[0].firstChild.nodeValue;

	byId('shortNameField').innerHTML = LineListOptionElement.getElementsByTagName( 'shortName' )[0].firstChild.nodeValue;
