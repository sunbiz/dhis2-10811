...
// ---- Common Options ----
var gMonths=["Thang 01","Thang 02","Thang 03","Thang 04","Thang 05","Thang 06","Thang 07","Thang 08","Thang 09","Thang 10","Thang 11","Thang 12"];
var gWeekDay=["CN","T2","T3","T4","T5","T6","T7"];	// weekday caption from Sunday to Saturday

var gBegin=[1920,1,1];	// static calendar range begin from [Year,Month,Date]
var gEnd=[2015,12,31];	// static calendar range end at [Year,Month,Date]
